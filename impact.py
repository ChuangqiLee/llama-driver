...
characterName = ''
fileOlder = ''
url = "https://genshin.honeyhunterworld.com/audio/quotes/" + characterName + fileOlder + ".wav"
...
myHeaders = {
    "authority": "genshin.honeyhunterworld.com",
    "User-Agent": random.choice(myUserAgent)
}
# print(headers)
url = "https://genshin.honeyhunterworld.com/audio/quotes/lisa/1000100_03_en.wav"
